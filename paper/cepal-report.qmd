...
Existing evidence reveals a sharp reduction in levels of overall mobility, including short- and long-distance movements, and some support for an urban exodus during the early days of COVID-2019 in 2020 as the pandemic was unfolding and strict nonpharmaceuthical measures were enacted \[@rowe2023\]. Population losses through internal population movements were documented for large core metropolitan areas in Spain \[@gonzález-leonardo2022b; @gonzález-leonardo2022c\], Germany \[@stawarz2022\], Sweden \[@vogiazides2022\], Japan \[@tønnessen2021\], Australia \[@perales2022\], the United States \[@ramani2021\] and Britain \[@rowe2022b\]. Suburban and outer parts of metropolitan areas (as in the 'donut effect' noted for US cities, see @ramani2021), as well as more distant rural areas, were identified as gaining population.

Yet, less is known about the extent and durability of population movements to and from large cities during the COVID-19 pandemic in the Global South and extending beyond 2020.
...
But, these data systems are not frequently updated and suffer from slow releases, with census data for example being collected over intervals of ten years in most Latin American countries and with a few month lag for the release of information [@cepal2022].
These systems thus lack the temporal granularity to analyse population movements over short-time periods [@green2021].
Digital footprints (DF) left as a result of social interactions on digital platforms offer an unique source of information to capture human population movement in the unfolding data revolution [@rowe2023big].
...
We focus primarily on national capital cities.
...
Our work contributes to expanding existing knowledge by offering new empirical evidence on the impacts of COVID‐19 on internal population movement.
...
The levels and patterns of internal population movements seem to have returned to those observed prior to the pandemic in some countries, while they have not in others.
Thus, the long-term effects of COVID-19 are yet to be established.
...
Nonetheless, a recent study demonstrated that wealthy individuals from large cities in Brazil, Colombia, Indonesia, Mexico, Philippines and South Africa moved to less populated areas during the first wave of COVID-19 [@lucchini2023].
...
This pattern was also found in Chile among high-income individuals leaving Santiago during the pandemic [@elejalde2023].
Wealthy individuals have the resources to move, are able to telework and own second residences away from cities.
Low-income population in the Global South however may lack resources to move.
In addition, a large proportion of vulnerable populations work in the informal economy which makes leaving cities difficult for them.
...
In March 2020, movements away from capital were limited but had expanded in volume and geographical extent by April 2022.

![Short-distance (\<100km) and long-distance (\>100km) movements from core areas in capital cities. March 2020 and April 2022.](../outputs/cloropleth-maps/cloropleth-arg.png){#fig-fig6}
...
Our data revealed that nearby urban and suburban areas, such as Moreno, La Matanza and Tigre in Argentina and Ecatepec de Morelos, Ciudad López Mateos and Chicoloapan de Juárez in Mexico absorbed over 80% of short-distance moves from Buenos Aires and Mexico City in April 2022.
To a lesser extent, these moves have been directed to rural areas.
Though, as we described in the previous section, these areas recorded a relatively large net balance of short-distance moves, particularly in Mexico, while short-distance movements are quite balanced in metropolitan core areas in Chile (@fig-fig4).
...
In Argentina and Chile, this pattern has been relatively uniform with areas closer to Buenos Aires and Santiago absorbing large numbers.
...
The bottom-left map in @fig-fig6 reveals that key destinations were coastal areas in the province of Valparaiso and central-southern areas in the provinces of Talca, Curico and Colchagua.
...
Additionally, the bottom-left map in @fig-fig6 for Chile shows that the provinces of Antofagasta and El Loa also attracted a relatively large number of moves.
The economy of these areas suggest that these were long-distance commuting moves, rather than migratory moves.

@fig-fig5 showed that metropolitan core areas in the three countries in our analysis have tended to record consistent positive balances of long-distance movements.
Contrary to early speculations of the death of cities, this pattern may reflect the resilience of cities to endure crises and as a key engine of economic growth, innovation and prosperity.
@fig-fig6 revealed the
