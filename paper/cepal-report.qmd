...
Location data have been proven key to monitor population movement and displacement during natural disasters, wars and epidemics, to develop appropriate policy responses.
We envision resources like those created by the European Commission Joint Research Centre \[REF\] and the Statistics Division of the United Nations \[REF\], identifying sources of non-traditional data and establishing methodological guidelines for the use of mobile phone data for official mobility statistics.
We envision these resources with a regional focus, reflecting differences in the local landscape of data and use of digital technology.

entativeness

-   we don't know who these people are

-   future work should look at area level data - just a dataset became available

-   hypotheses to test - wealthy people migrate - poor people move more locally

DFD for policy - access - key policy implication - framework to process data
